                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">Total Peminjaman:
                                    {{ $data->count() }}</span>
                            </h3>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-peminjaman-table-filter="search"
                                ...
                                <table class="table table-striped table-bordered" id="tabel_peminjaman">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Status</th>
                                            @php
                                            $showDendaColumn = false;
                                            foreach ($data as $peminjaman) {
                                            if ($peminjaman->status == 'denda') {
                                            $showDendaColumn = true;
                                            break;
                                            }
                                            }
                                            @endphp
                                    ...
                                    <tbody>
                                        ...
                                        @if (in_array($peminjaman->status, ['pending', 'disetujui', 'dikembalikan',
                                        'denda']))
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                                                <img src="{{ Storage::url($peminjaman->buku->foto) }}" width="50px"
                                                    alt="Foto Buku">
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <br>
                                                <small class="text-muted">({{ $hariTerlambat }} hari × Rp 3.000)</small>
                                            @endif
                                            </td>
                                            @endif
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3 update-status"
                                                            data-id="{{ $peminjaman->id }}" data-status="disetujui"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3 update-status"
                                                            data-id="{{ $peminjaman->id }}" data-status="ditolak"
                                                            data-judul="{{ $peminjaman->buku->judul ?? '' }}">
                                                            Tolak
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3 update-status"
                                                            data-id="{{ $peminjaman->id }}" data-status="dikembalikan"
                                                            data-judul="{{ $peminjaman->buku->judul ?? '' }}">
                                                            Kembalikan
                                                        </a>
                                                    </div>
                                                    ...
                                                    'ditolak']))
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3 delete-peminjaman"
...
<script>      
    ...
    const successMessages = {
        ...
        ditolak: 'Peminjaman buku berhasil ditolak',
