                    ...
                    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
                        ...
                        <div class="container-xxl d-flex flex-grow-1 flex-stack">
							...
							<div class="d-flex align-items-center flex-shrink-0">
                                ...
                                <!--end::User -->
<!--begin::Menu wrapper-->
<div class="app-navbar-item" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
    <!--begin::Menu toggle button-->
    <button class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-active-bg-light w-30px h-30px w-lg-40px h-lg-40px">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="/contact-us" class="menu-link px-5">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
            <a href="/help" class="menu-link px-5">
