                    ...
                    <div class="card card-flush h-xl-100">  
                        ...
                        <div class="card-header pt-7">  
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-users-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Users" />
                            </div>
                            <!--end::Search-->
                            <!--end::Title-->  
                            <!--begin::Toolbar-->  
                                ...
                                <table class="table table-striped table-bordered" id="tabel_users">      
                                    ...
                                    <tbody>  
                                        @foreach ($users as $key => $user)    
                                            <tr>    
                                                <td>{{ $key + 1 }}</td>    
                                                <td><img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('assets/media/avatars/blank.png') }}"alt="avatar" width="50px" /></td>
                                                <td>{{ $user->name }}</td>    
                                                <td>{{ $user->email }}</td>    
                                                <td>{{ $user->role }}</td>    
                                                <td> 
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                        <div class="menu-item px-3">   
                                                            <a href="{{ route('member.edit', $user) }}" class="menu-link px-3 btn-edit" >Edit</a>
                                                        </div>
                                                        <div class="menu-item px-3">
                                                            <a href="" class="menu-link px-3 btn-delete" data-user-id="{{ $user->id }}">Delete</a>
                                                        </div>
                                                </td>    
                                            </tr>    
                                        @endforeach    
...
<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form class="form" action="{{ route('member.store') }}" method="POST" id="kt_modal_add_customer_form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
                        ...
                        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                <div class="fw-semibold">
                                    <div class="fs-6 text-gray-700">Detail pengguna akan dicatat dalam sistem. Untuk informasi lebih lanjut, silakan baca
                        ...
                        <div class="fw-bold fs-3 rotate collapsible mb-7"
                            href="#kt_modal_add_customer_user_info" role="button" aria-expanded="true"
                            aria-controls="kt_modal_add_customer_user_info">Detail Akun Pengguna
...
@section('script')
    <script>
// Pastikan dokumen sudah selesai dimuat
